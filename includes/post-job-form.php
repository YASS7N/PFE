...
<form action="../controllers/post-job.php" method="POST">
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="job-title" class="form-control" placeholder="e.g. Front end Developer" required>
        </div>
        <div class="col-md-6 mb-3">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="location" class="form-control" placeholder="e.g. Casablanca, Morocco" required>
        </div>
        <div class="col-6 mb-3">
            <label class="form-label">Required Skills</label>
            <input type="text" name="skills" class="form-control" placeholder="e.g. Javascript, PHP" required>
        </div>
        <div class="col-md-6 mb-3">
